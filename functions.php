...
?>
With the last argument array('jquery') you're telling WP to include the script AFTER jQuery. Note that every script must use a different handle (first parameter “boot1”).
